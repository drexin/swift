...
void
ScalarTypeLayoutEntry::refCountString(IRGenModule &IGM,
                                      LayoutStringBuilder &B) const {
...
void ArchetypeLayoutEntry::refCountString(IRGenModule &IGM,
  ...
  for (auto param : params) {
    B.addRefCount(LayoutStringBuilder::RefCountingKind::Generic, param->getIndex());
  }
}
...
llvm::Constant *TypeInfoBasedTypeLayoutEntry::layoutString(IRGenModule &IGM) const {
  return nullptr;
}
